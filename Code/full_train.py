...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 31 01:06:09 2019
...
def train_stage_1():
    ...
    for img_id in os.listdir('/Users/bhargavdesai/Desktop/Projects/Skin Cancer Detection/Dataset/skin-cancer-mnist-ham10000/Final 3/Full Train'):
        if (img_id=='.DS_Store'):
...
train_stage_1_df.to_csv('/Users/bhargavdesai/Desktop/Projects/Skin Cancer Detection/Dataset/skin-cancer-mnist-ham10000/Final 3/Processed (.csv) Files/train_categorical_full_df.csv', index=False)

def initialise_training_set_with_labels():
    train_stage_1_df = pd.read_csv('/Users/bhargavdesai/Desktop/Projects/Skin Cancer Detection/Dataset/skin-cancer-mnist-ham10000/Final 3/Processed (.csv) Files/train_categorical_full_df.csv')
...
def ndarray_from_list(x_train_list, y_train_list):
    ...
    for idx, img_id in enumerate(x_train_list,0):
        if (img_id=='.DS_Store'):
            print("---------------Found .DS_Store File breaking the loop-------------------------------------")
            break
        image = cv2.imread('/Users/bhargavdesai/Desktop/Projects/Skin Cancer Detection/Dataset/skin-cancer-mnist-ham10000/Final 3/Full Train'+'/'+img_id, 1) 
        x_train[idx, :, :, :] = image
...
def train_model(x_train, y_train, model):
    ...
    tensorboard = TensorBoard(log_dir='/Users/bhargavdesai/Desktop/Projects/Skin Cancer Detection/Dataset/skin-cancer-mnist-ham10000/Final 3/Logs/Full Train'.format(time()))
    model.fit(x= x_train,y = y_train, epochs= 500, batch_size = 32, callbacks=[TerminateOnBaseline(monitor='acc', baseline=0.88), tensorboard])   
    model.save('full_train_categorical_lr=0.000005_trained-on-mac.h5')
    del model
    print("-------End of Line-------------")
